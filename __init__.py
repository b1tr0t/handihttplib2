...
class Response(dict):
    ...
    def __init__(self, info):
        ...
        if isinstance(info, httplib.HTTPResponse):
            ...
            ## Begin hackish fix cookie stuff
            if self.has_key('set-cookie'):
                cookiestring = ''
                for cookieline in info.msg.getallmatchingheaders('Set-Cookie'):
                    cookiestring += cookieline.replace('Set-Cookie: ', '').replace('\r','').replace('\n',';')
                self['set-cookie'] = cookiestring
